...
export SPEC=extension+o2m_
export APPNAME=extensiono2m
...
rm -rf $SDK_PROJECT_ROOT/feign/src/main/java/biz/doublegsoft/extensiono2m/dto/assembler
rm -rf $SDK_PROJECT_ROOT/feign/src/test
